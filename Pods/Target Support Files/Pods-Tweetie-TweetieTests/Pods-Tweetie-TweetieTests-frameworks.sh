...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/RxRelay-iOS12.0/RxRelay.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxBlocking-iOS12.0/RxBlocking.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxTest-iOS12.0/RxTest.framework"
fi
